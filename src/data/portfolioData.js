...
export const personal = {
  ...
  subtitle: "React.js Developer · UI Engineer · Chennai, TN",
  bio: "Hey there, I'm Harish! I'm a Frontend Developer who obsesses over clean code, smooth animations, and digital interfaces that don't just work, but feel incredibly satisfying to use. Based in Chennai, I specialize in building stunning React applications that integrate seamlessly with robust .NET APIs.",
...
export const projects = [
  {
    ...
    description: "I engineered two high-volume e-commerce applications. I built interactive catalogs, bulk-ordering flows, real-time inventory dashboards, and integrated secure payment gateways with .NET API endpoints.",
    links: [
...
export const askHarishReplies = {
  "available": "Absolutely! I'm currently looking for new frontend opportunities, full-time engineering roles, or creative freelance work. Shoot me an email at harish.tech02@gmail.com — let's build something cool!",
  ...
  "tech": "My core stack is React.js, modern JavaScript (ES6+), and Tailwind CSS. For backends, I consume .NET Core REST APIs via Axios. I also love using Framer Motion for premium animations!",
